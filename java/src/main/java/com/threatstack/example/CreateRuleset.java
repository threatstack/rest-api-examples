...
public class CreateRuleset {
    public static void main(String[] args) {
        ...
        String[] ruleIds = new String[0];

        Dictionary rulesetData = new Hashtable();
        rulesetData.put("name", "API Test Ruleset");
        rulesetData.put("description", "This ruleset was created as a test of the Threat Stack REST API");
        rulesetData.put("ruleIds", ruleIds);

        //Convert that object to a JSON string
        Gson gson = new Gson();
        String postData = gson.toJson(rulesetData);
